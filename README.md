...
<img width="1770" height="992" alt="시스템아키텍처" src="https://github.com/user-attachments/assets/a3096085-c5a2-4562-b921-03a39bf8a781" />

## 6. 🖼️ WBS

<img width="1746" height="604" alt="WBS" src="https://github.com/user-attachments/assets/86b44521-80ff-44e6-be08-d2ec7d2da2fe" />

## 7. 📝요구사항 명세서

<img width="1240" height="297" alt="요구사항" src="https://github.com/user-attachments/assets/299a970a-a4f6-4f71-bf9b-3e71d20c46b9" />
...
| 전처리 전                                                                                                                           | 전처리 후                                                                                                                           |
| ----------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| <img width="1314" height="558" alt="전처리전" src="https://github.com/user-attachments/assets/28c9678f-d734-49b6-adb1-7ece85f1d47d" /> | <img width="1212" height="758" alt="전처리후" src="https://github.com/user-attachments/assets/3eb81518-0f8d-47b5-a11d-8ad7e6c1dd85" />
...
<img width="1419" height="658" alt="ERD" src="https://github.com/user-attachments/assets/37e89728-4ef9-4bd4-89ea-daa6555c3e59" />
...
| 전처리 전                                                                                                                           | 전처리 후                                                                                                                          |
| ----------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| <img width="1484" height="658" alt="레그전처리 전" src="https://github.com/user-attachments/assets/3f91850f-2f31-476a-8d7d-18487e4cf9fc" />  | <img width="781" height="310" alt="레그후" src="https://github.com/user-attachments/assets/6093d869-ce8a-43be-a59c-05bf0feb994e" /> |
...
**비자 모의면접 전체 흐름**
<img width="1351" height="573" alt="비자 모의면접 전체흐름 1" src="https://github.com/user-attachments/assets/31a8aa46-0f5a-4ea2-a9b8-7ec1bb7b4a31" />
<img width="1349" height="736" alt="비자모의전체흐름2" src="https://github.com/user-attachments/assets/99ed2647-e7ee-4e17-9b70-07c1e735c0bd" />
...
| **이름** | **회고 내용** |
| -------- | ------------- |
| 권민세   |rag의 구조를 제대로 이해하고 불러오는 과정을 확실하게 이해할 수 있어서 좋았다. 하지만 프롬프트에 따라서 불러온 rag데이터를 활용하여 내는 질문이 천지차이여서 어려웠다. 이 때문에 rag용 데이터나 파인튜닝 데이터를 찾아보려고 많은 노력을 했지만 쉽지 않아서 아쉬웠다. 프롬프트는 어느정도 엔지니어링 해봤으니 파인튜닝도 적용해보고 싶다
